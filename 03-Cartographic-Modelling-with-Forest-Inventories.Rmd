...
**Step 1:** Now that we have prepared our layers, we will calculate the percentage of old growth forest within each land unit. To do this we’ll create a key that uniquely identifies each Landscape Unit + BEC zone code + BEC subzone combination. 

**Pro tip:** This is a good opportunity to close any unneeded attribute tables or turn off layer visibility.
