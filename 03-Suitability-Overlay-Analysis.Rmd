...
##### Q1. What was the SQL expression that you used to export only the humpback whale BIA? (3 points) {.unnumbered}
...
##### Q6. What is the maximum value for Area to four decimal places? (1 point) {.unnumbered}
##### Q7. What is the maximum value for Sightings to four decimal places? (1 point) {.unnumbered}
##### Q8. What is the maximum value for Vessels to four decimal places? (1 point) {.unnumbered}
