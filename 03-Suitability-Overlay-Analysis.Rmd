...
<input type="checkbox" unchecked> An output table of the top 5 ranked features</input>
<input type="checkbox" unchecked> Map of the final product</input>
<input type="checkbox" unchecked> Answers to the questions submitted on the course management system</input>
