...
**Step 2:** Enter the following command `git config --global user.name "student"` and press enter. Next, enter the following command `git config --global email "you@example.com"`. Git is now configured and you can close the Git Bash.
