...
**Step 6:** From the Browser or Object Explorer pane on the left, expand "Servers", "PostgreSQL XX" (where "XX" is your current PostgreSQL version), "Databases", "ubcv", "Schemas", then expand "public", then expand "Tables" to view all the tables in the ubcv database. 
...
```{r 01-pgadmin-ubcv-buildings, out.width= "100%", echo = FALSE}
...
```{r 01-pgadmin-ubcv-query, out.width= "100%", echo = FALSE}
...
```{r 01-qgis-postgres-connection, out.width= "40%", echo = FALSE}
...
```{r 01-qgis-browser-ubcv, out.width= "25%", echo = FALSE}
...
```{r 01-qgis-query-properties, out.width= "100%", echo = FALSE}
...
```{r 01-arcgispro-postgres-connection, out.width= "40%", echo = FALSE}
...
The prompt should say `Server [localhost]:`. Type "FRST-GIS.ead.ubc.ca" and then hit "Enter" on your keyboard.
